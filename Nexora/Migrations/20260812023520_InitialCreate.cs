        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreTienda = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "bi-phone", "Celulares" },
                    { 2, "bi-laptop", "Laptops" },
                    { 3, "bi-tablet", "Tablets" },
                    { 4, "bi-headphones", "Audio" },
                    { 5, "bi-controller", "Gaming" },
                    { 6, "bi-plug", "Accesorios" }
                });
